const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=653115c2b12015a06e90d44cf9a1fe16&units=imperial';
fetch(apiURL)
...
const apiURLf = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=653115c2b12015a06e90d44cf9a1fe16&units=imperial';
fetch(apiURLf)
  .then((response) => response.json())
  .then((jsObject) => {
